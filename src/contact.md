---
title: "Contact MermaidKaz"
description: "Get in touch with Kaz, Tasmania's first PADI Mermaid Instructor. Book your mermaid experience, ask questions, or inquire about custom programs. Professional mermaid services across Tasmania."
layout: page
---

# Get in Touch

Ready to dive into your mermaid journey? Whether you have questions about our services, want to book an experience, or need information about custom programs, we'd love to hear from you!

---

## 📅 Book Your Experience

The easiest way to get started is to book a consultation or session directly through our online booking system.

<div class="booking-section">
  <a href="https://tidycal.com/mermaidkaz" class="button button-primary" target="_blank" rel="noopener">
    📅 Book Now via TidyCal
  </a>
</div>
...
- **Photography studios**: Underwater photography setups
- **Retreat venues**: Curated locations for multi-day experiences
...
1. **Quick Response**: We'll respond within 24 hours (usually much sooner!)

2. **Consultation Call**: For complex bookings, we'll schedule a brief consultation to understand your needs perfectly
...
4. **Booking Confirmation**: Secure your date with a simple booking process

5. **Pre-Session Support**: Receive detailed preparation guides and answer any last-minute questions

---

## 🌊 Ready to Make Magic?

Don't let another day pass without taking the first step toward your mermaid transformation. Whether you're dreaming of PADI certification, planning an unforgettable event, or seeking the ultimate retreat experience, your mermaid journey starts with a simple message.

<div class="contact-cta">
  <h3>Choose Your Preferred Contact Method:</h3>
  <div class="contact-buttons">
    <a href="https://tidycal.com/mermaidkaz" class="button button-primary" target="_blank" rel="noopener">📅 Book Online</a>
    <a href="mailto:info@mermaidkaz.com" class="button button-secondary">📧 Send Email</a>
    <a href="https://www.instagram.com/mermaid_kaz/" class="button button-secondary" target="_blank" rel="noopener">📱 Instagram DM</a>
  </div>
</div>
