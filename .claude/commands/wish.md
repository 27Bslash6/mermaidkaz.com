...
- **Analysis requests** → mermaidkaz-analyzer agent
- **Planning needs** → mermaidkaz-dev-planner agent  
- **Architecture design** → mermaidkaz-dev-designer agent
- **Implementation tasks** → mermaidkaz-dev-coder agent
- **Debugging issues** → mermaidkaz-dev-fixer agent
- **Complex coordination** → mermaidkaz-clone agent
- **Agent creation** → mermaidkaz-agent-creator agent
- **System enhancement** → mermaidkaz-self-enhancer agent
- **Documentation** → mermaidkaz-claudemd agent
- **Agent optimization** → mermaidkaz-agent-enhancer agent
